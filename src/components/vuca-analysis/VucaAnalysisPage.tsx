...
const VUCA_COLORS: Record<string, string> = {
  VOLATILE: '#EF4444', UNCERTAIN: '#F59E0B', COMPLEX: '#3B82F6', AMBIGUOUS: '#8B5CF6',
};
        ...
        <div style={{ maxWidth: 700, margin: '48px auto 0', padding: '0 24px' }}>
          ...
          <div style={{ background: `linear-gradient(135deg, ${NAVY}, #0a2233)`, border: '1px solid #1e4a5e', borderRadius: 14, padding: '36px 32px' }}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div style={{ background: `${BLUE}08`, border: `1px solid ${BLUE}25`, borderRadius: 8, padding: '12px 14px', marginBottom: 18, fontSize: 12, color: '#7eaabf', lineHeight: 1.5 }}>
              ...
              <div style={{ marginBottom: 16 }}>
                ...
                <input
                  ...
                  style={{ width: '100%', background: '#0a1929', border: `1px solid ${companyName.trim() ? BLUE + '66' : '#1e4a5e'}`, borderRadius: 8, color: '#E8EDF5', padding: '11px 14px', fontSize: 14, outline: 'none', boxSizing: 'border-box', transition: 'border-color 0.2s' }}
                />
              </div>
              ...
              <div style={{ marginBottom: 28 }}>
                ...
                <input
                  ...
                  style={{ width: '100%', background: '#0a1929', border: `1px solid ${companyDomain.trim() ? BLUE + '66' : '#1e4a5e'}`, borderRadius: 8, color: '#E8EDF5', padding: '11px 14px', fontSize: 14, outline: 'none', boxSizing: 'border-box', transition: 'border-color 0.2s' }}
                />
